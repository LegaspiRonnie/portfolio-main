...
export default function Services() {
  return (
    <IconCardGrid
      ...
      subheading="From a single landing page to a full custom system — here's what I take on."
      items={services}
      iconSize="w-11 h-11"
    >
      <div className="mt-8 text-center">
        <Link to="/pricing" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-blue-700 hover:bg-blue-800 text-white text-sm font-medium transition-all duration-200 hover:scale-[1.03] active:scale-[0.98]">
