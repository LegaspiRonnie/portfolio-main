...
<body class="bg-white dark:bg-gray-950 transition-colors duration-300">
    ...
    <div class="min-h-screen flex flex-col items-center justify-center text-center px-6">
        <p class="font-mono text-sm text-blue-700 dark:text-blue-400 mb-3">403</p>
        <h1 class="text-2xl md:text-3xl font-semibold text-gray-900 dark:text-white mb-3">Access forbidden</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mb-8 max-w-sm">
            You don't have permission to view this page.
        </p>
        <a href="{{ route('home') }}" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-blue-700 hover:bg-blue-800 text-white text-sm font-medium transition-all duration-200 hover:scale-[1.03] active:scale-[0.98]">
            Back to home
        </a>
    </div>
