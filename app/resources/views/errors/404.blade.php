...
<body class="bg-white dark:bg-gray-950 transition-colors duration-300">
    ...
    <div class="min-h-screen flex flex-col items-center justify-center text-center px-6">
        <p class="font-mono text-sm text-blue-700 dark:text-blue-400 mb-3">404</p>
        <h1 class="text-2xl md:text-3xl font-semibold text-gray-900 dark:text-white mb-3">Page not found</h1>
